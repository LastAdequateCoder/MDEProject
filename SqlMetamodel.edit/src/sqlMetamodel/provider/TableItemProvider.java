...
/**
 * This is the item provider adapter for a {@link sqlMetamodel.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SqlMetamodelPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SqlMetamodelPackage.Literals.TABLE__PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addForeignKeysPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_foreignKeys_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_foreignKeys_feature", "_UI_Table_type"),
				 SqlMetamodelPackage.Literals.TABLE__FOREIGN_KEYS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIndexesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_indexes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_indexes_feature", "_UI_Table_type"),
				 SqlMetamodelPackage.Literals.TABLE__INDEXES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SqlMetamodelPackage.Literals.TABLE__COLUMNS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SqlMetamodelPackage.Literals.TABLE__COLUMNS,
				 SqlMetamodelFactory.eINSTANCE.createColumn()));
	}
