...
/**
 * This is the item provider adapter for a {@link sqlMetamodel.ForeignKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForeignKeyItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReferencedColumnsPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SqlMetamodelPackage.Literals.FOREIGN_KEY__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SqlMetamodelPackage.Literals.FOREIGN_KEY__REFERENCED_TABLE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Referenced Columns feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReferencedColumnsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 ...
				 SqlMetamodelPackage.Literals.FOREIGN_KEY__REFERENCED_COLUMNS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addColumnsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForeignKey_columns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForeignKey_columns_feature", "_UI_ForeignKey_type"),
				 SqlMetamodelPackage.Literals.FOREIGN_KEY__COLUMNS,
				 true,
				 false,
				 true,
				 null,
