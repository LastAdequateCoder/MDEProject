...
public class Generate extends AbstractAcceleoGenerator {
    ...
    public static void main(String[] args) {
    	// Load the Ecore model and register its package URI
        ResourceSet resourceSet = new ResourceSetImpl();
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("ecore", new EcoreResourceFactoryImpl());
        
        URI metamodelURI = URI.createFileURI("C:\\Users\\baran\\OneDrive\\Рабочий стол\\MDEProject\\SQLMetamodel\\model\\Sqlmetamodel.ecore");
        Resource ecoreResource = resourceSet.getResource(metamodelURI, true);
        
        // Ensure the package is registered
        EPackage.Registry.INSTANCE.put("http://www.example.org/sqlDatabaseMetamodel", ecoreResource.getContents().get(0));
        try {
            if (args.length < 2) {
